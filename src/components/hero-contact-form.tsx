        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="group relative">
            <input
              ...
              className={`w-full border rounded-lg bg-white text-primary py-2.5 px-3 text-base focus:outline-none focus:ring-2 focus:ring-secondary transition duration-300 ${errors.name ? 'border-red-500' : 'border-gray-300'}`}
            />
          ...
          <div className="group relative">
            <input
              ...
              className={`w-full border rounded-lg bg-white text-primary py-2.5 px-3 text-base focus:outline-none focus:ring-2 focus:ring-secondary transition duration-300 ${errors.email ? 'border-red-500' : 'border-gray-300'}`}
            />
          ...
          <div className="group relative custom-select-wrapper">
            <select
              ...
              {...register("service")}
              // Applied HTML styles
              className={`block w-full border rounded-lg bg-white text-primary py-2.5 px-3 text-base focus:outline-none focus:ring-2 focus:ring-secondary cursor-pointer custom-select-arrow ${errors.service ? 'border-red-500' : 'border-gray-300'}`}
            >
          ...
          <div className="group relative">
            <textarea 
                ...
                // Applied HTML styles
                className={`w-full border rounded-lg bg-white text-primary py-2.5 px-3 text-base focus:outline-none focus:ring-2 focus:ring-secondary resize-none transition duration-300 ${errors.problems ? 'border-red-500' : 'border-gray-300'}`}
            />
