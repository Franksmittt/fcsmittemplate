        ...
        <div className="max-w-7xl mx-auto">
            ...
            >
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    {/* 1. Primary CTA: Direct Call Button (Emphasized) */}
                    <Button asChild 
                    ...
                    {/* 2. Secondary CTA: Quote/Form Button (Subtle Link) */}
                    <Button asChild 
                        className="h-12 text-base font-bold bg-white hover:bg-gray-100 text-primary 
