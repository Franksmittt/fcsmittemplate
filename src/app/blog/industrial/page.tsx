// src/app/blog/industrial/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';
import { Button } from '@/components/ui/button';
import { CtaFinalStrip } from '@/components/cta-final-strip';
import { Factory, Shield, Wrench } from 'lucide-react'; // REMOVED: Building
...
// --- DATA: Featured Industrial Content (Placeholders) ---
...
// --- MAIN PAGE COMPONENT ---
export default function IndustrialBlogIndexPage() {
    return (
        <div className="bg-primary pt-24 text-white min-h-screen">

            {/* --- MODULE 1: INDUSTRIAL BLOG HERO --- */}
            <section className="relative py-24 md:py-32 px-4 bg-gray-900 border-b-4 border-secondary">
                <div className="max-w-7xl mx-auto">
                    ...
                    <p className="2xl font-light mt-6 max-w-4xl text-gray-400">
                        Technical articles dedicated to **corrosion control, high-performance coatings,** and structural preservation for commercial and manufacturing plants.
                    </p>
                    ...
                    >
                        <Link href="/contact">
                            Request a Technical Consultation &rarr;
                        </Link>
                    </Button>
                </div>
            </section>
