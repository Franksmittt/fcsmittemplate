...
import { ClipboardCheck, Shield, Wrench, FlaskConical, Building, Layers, Home, Factory, Phone } from 'lucide-react'; // Removed HardHat and Scroll
...
export const metadata: Metadata = {
    title: 'Specialized Painting, Waterproofing & Structural Repair Services | Maverick',
    description: 'A structural asset maintenance partner offering turn-key solutions for commercial, industrial, and body corporate properties, including structural repairs, specialized coatings, and Independent QA.',
};
            ...
            <section className="py-24 md:py-32 px-4 bg-gray-900 text-white">
                <div className="max-w-7xl mx-auto">
                    <header className="text-center max-w-4xl mx-auto mb-16">
                        ...
                        <p className="text-xl text-gray-400 font-light">
                            Select an expertise area below to see how we apply advanced methods and verifiable quality to your specific maintenance challenge.
                        </p>
                    </header>
                            ...
                            return (
                                ...
                                >
                                    <div>
                                        ...
                                        <h3 className={titleClass + " font-extrabold uppercase text-white mb-2 leading-snug"}>
                                            {pillar.title}
                                        </h3>
